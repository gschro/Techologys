...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 02, 2014 at 04:48 AM
...
CREATE TABLE IF NOT EXISTS `emailaccount` (
  ...
  `PSALT` int(64) NOT NULL,
  `HASHPASS` int(128) NOT NULL,
  PRIMARY KEY (`ID`),
  KEY `USERID` (`USERID`)
...
INSERT INTO `emailaccount` (`ID`, `USERID`, `EMAIL`, `FIRSTNAME`, `LASTNAME`, `PSALT`, `HASHPASS`) VALUES
(1, 1, 'bobbyj@web.edu', 'Bobby', 'Johnson', 1234, 56781234);
